...
<?php (isset ($title) && isset ($meta_d) && isset ($meta_k) && isset ($date) && isset ($description) && isset ($text) && isset ($author))
{
/*Здесь пишем, что можно заносить информацию в базу*/
$result = mysqli_query ("UPDATE lessons SET title='$title', meta_d='$meta_d', meta_k='$meta_k', date='$date', description='$description', text='$text', author='$author' WHERE id='$id'");
...
{"<p>Вы ввели не всю информацию, поэтому урок не может быть обновлен в базе</p>";
}
?>
